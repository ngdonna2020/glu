...
train GLU on a samller sample for your code
...
Hint: To keep the parameter count and computational cost similar to the original FFN, the hidden dimension $d_{ff}$ is reduced.
